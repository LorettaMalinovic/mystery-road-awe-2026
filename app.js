// =============================================================================
// Exercise 1 - Entry (ES module)
// Der Original-Code von app.js ist unten komplett auskommentiert stehen geblieben.
// Die laufende Logik liegt in js/*.js (Demo 1: native ES-Module, kein Bundler).
// =============================================================================
...
// Demo 1: Module erzeugen keine Globals. index.html behaelt onclick="navigateTo(...)" usw.,
// deshalb werden die Handler bewusst an window gehaengt.
...
// =============================================================================
// ORIGINAL app.js (auskommentiert - nicht geloescht)
// =============================================================================
...
//   showLoadingOverlay("Loading case fileâ€¦");
...
//   html += '<button class="bookmark-btn ' + (isBookmarked ? "active" : "") + '" data-action="bookmark" data-id="' + ev.id + '" aria-label="Toggle bookmark for ' + ev.title + '"><span class="bookmark-icon">' + (isBookmarked ? "â˜…" : "â˜†") + "</span></button>";
//   html += "<h3>" + ev.title + "</h3>";
...
//   suspectSelect.innerHTML = '<option value="">Select a personâ€¦</option>';
//   for (var p = 0; p < allPeople.length; p++) {
